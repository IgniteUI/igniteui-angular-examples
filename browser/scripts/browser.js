...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "19.1.0-beta.1", name: "igniteui-angular-core" },
        { version: "19.1.0-beta.1", name: "igniteui-angular-charts" },
        { version: "19.1.0-beta.1", name: "igniteui-angular-excel" },
        { version: "19.1.0-beta.1", name: "igniteui-angular-gauges" },
        { version: "19.1.0-beta.1", name: "igniteui-angular-data-grids" },
        { version: "19.1.0-beta.1", name: "igniteui-angular-inputs" },
        { version: "19.1.0-beta.1", name: "igniteui-angular-layouts" },
        { version: "19.1.0-beta.1", name: "igniteui-angular-maps" },
        { version: "19.1.0-beta.1", name: "igniteui-angular-spreadsheet-chart-adapter"  },
        { version: "19.1.0-beta.1", name: "igniteui-angular-spreadsheet" },
        { version: "19.1.0-beta.1", name: "igniteui-angular-datasources" },
        { version: "19.1.0-beta.1", name: "igniteui-angular-dashboards" },
