...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "19.1.0-beta.0", name: "igniteui-angular-core" },
        ...
        { version: "19.1.0-beta.0", name: "igniteui-angular-maps" },
        { version: "19.1.0-beta.0", name: "igniteui-angular-spreadsheet-chart-adapter"  },
        { version: "19.1.0-beta.0", name: "igniteui-angular-spreadsheet" },
        { version: "19.1.0-beta.0", name: "igniteui-angular-datasources" },
        { version: "19.1.0-beta.0", name: "igniteui-angular-dashboards" },
        // these IG packages are sometimes updated:
        { version: "6.0.0" , name: "igniteui-webcomponents" },
        { version: "15.1.1", name: "igniteui-theming" },
        { version: "19.2.7", name: "igniteui-angular" },
        { version: "19.2.12", name: "@angular/animations" },
        { version: "19.2.12", name: "@angular/common" },
        { version: "19.2.12", name: "@angular/compiler" },
        { version: "19.2.12", name: "@angular/core" },
        { version: "19.2.12", name: "@angular/forms" },
        { version: "19.2.12", name: "@angular/platform-browser" },
        { version: "19.2.12", name: "@angular/platform-browser-dynamic" },
        ...
        // dev packages:
        { version: "19.2.13" , name: "@angular/cli" },
        { version: "19.2.12" , name: "@angular/compiler-cli" },
        { version: "19.2.12" , name: "@angular/language-service" },
        { version: "19.2.13" , name: "@angular-devkit/build-angular" },
