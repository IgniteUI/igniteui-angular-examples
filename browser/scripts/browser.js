...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "21.0.0-beta.0", name: "igniteui-angular-core" },
        { version: "21.0.0-beta.0", name: "igniteui-angular-charts" },
        { version: "21.0.0-beta.0", name: "igniteui-angular-excel" },
        { version: "21.0.0-beta.0", name: "igniteui-angular-gauges" },
        { version: "21.0.0-beta.0", name: "igniteui-angular-data-grids" },
        { version: "21.0.0-beta.0", name: "igniteui-angular-inputs" },
        { version: "21.0.0-beta.0", name: "igniteui-angular-layouts" },
        { version: "21.0.0-beta.0", name: "igniteui-angular-maps" },
        { version: "21.0.0-beta.0", name: "igniteui-angular-spreadsheet-chart-adapter"  },
        { version: "21.0.0-beta.0", name: "igniteui-angular-spreadsheet" },
        { version: "21.0.0-beta.0", name: "igniteui-angular-datasources" },
        { version: "21.0.0-beta.0", name: "igniteui-angular-dashboards" },
