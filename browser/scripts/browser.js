...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "20.0.2-beta.2", name: "igniteui-angular-core" },
        { version: "20.0.2-beta.2", name: "igniteui-angular-charts" },
        { version: "20.0.2-beta.2", name: "igniteui-angular-excel" },
        { version: "20.0.2-beta.2", name: "igniteui-angular-gauges" },
        { version: "20.0.2-beta.2", name: "igniteui-angular-data-grids" },
        { version: "20.0.2-beta.2", name: "igniteui-angular-inputs" },
        { version: "20.0.2-beta.2", name: "igniteui-angular-layouts" },
        { version: "20.0.2-beta.2", name: "igniteui-angular-maps" },
        { version: "20.0.2-beta.2", name: "igniteui-angular-spreadsheet-chart-adapter"  },
        { version: "20.0.2-beta.2", name: "igniteui-angular-spreadsheet" },
        { version: "20.0.2-beta.2", name: "igniteui-angular-datasources" },
        { version: "20.0.2-beta.2", name: "igniteui-angular-dashboards" },
