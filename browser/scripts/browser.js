...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { name: "igniteui-angular-core"                     , version: "17.3.0" },
        { name: "igniteui-angular-charts"                   , version: "17.3.0" },
        { name: "igniteui-angular-excel"                    , version: "17.3.0" },
        { name: "igniteui-angular-gauges"                   , version: "17.3.0" },
        { name: "igniteui-angular-inputs"                   , version: "17.3.0" },
        { name: "igniteui-angular-layouts"                  , version: "17.3.0" },
        { name: "igniteui-angular-maps"                     , version: "17.3.0" },
        { name: "igniteui-angular-spreadsheet-chart-adapter", version: "17.3.0" },
        { name: "igniteui-angular-spreadsheet"              , version: "17.3.0" },
        { name: "igniteui-angular-datasources"              , version: "17.3.0" },
