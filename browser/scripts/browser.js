...
function updateIG(cb) {
    ...
    // { name: "@infragistics/igniteui-angular-charts", version: "22.1.79" }, // proget
    // { name:               "igniteui-angular-charts", version: "14.1.0" },  // npm
    let packageUpgrades = [
        // these IG packages are often updated:
        { name: "@infragistics/igniteui-angular-core"                     , version: "22.1.79" },
        { name: "@infragistics/igniteui-angular-charts"                   , version: "22.1.79" },
        { name: "@infragistics/igniteui-angular-excel"                    , version: "22.1.79" },
        { name: "@infragistics/igniteui-angular-gauges"                   , version: "22.1.79" },
        { name: "@infragistics/igniteui-angular-layouts"                  , version: "22.1.79" },
        { name: "@infragistics/igniteui-angular-maps"                     , version: "22.1.79" },
        { name: "@infragistics/igniteui-angular-spreadsheet-chart-adapter", version: "22.1.79" },
        { name: "@infragistics/igniteui-angular-spreadsheet"              , version: "22.1.79" },
        { name: "@infragistics/igniteui-angular-datasources"              , version: "22.1.79" },
