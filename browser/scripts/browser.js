...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { name: "igniteui-angular-core"                     , version: "17.2.0-beta.0" },
        { name: "igniteui-angular-charts"                   , version: "17.2.0-beta.0" },
        { name: "igniteui-angular-excel"                    , version: "17.2.0-beta.0" },
        { name: "igniteui-angular-gauges"                   , version: "17.2.0-beta.0" },
        { name: "igniteui-angular-inputs"                   , version: "17.2.0-beta.0" },
        { name: "igniteui-angular-layouts"                  , version: "17.2.0-beta.0" },
        { name: "igniteui-angular-maps"                     , version: "17.2.0-beta.0" },
        { name: "igniteui-angular-spreadsheet-chart-adapter", version: "17.2.0-beta.0" },
        { name: "igniteui-angular-spreadsheet"              , version: "17.2.0-beta.0" },
        { name: "igniteui-angular-datasources"              , version: "17.2.0-beta.0" },
        // these IG packages are sometimes updated:
        { name: "igniteui-webcomponents",            version: "4.6.0" },
        { name: "igniteui-theming",                  version: "4.0.1" },
        { name: "igniteui-angular",                  version: "17.0.8" },
