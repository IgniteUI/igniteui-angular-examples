...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { name: "@infragistics/igniteui-angular-core"                     , version: "23.2.202" },
        { name: "@infragistics/igniteui-angular-charts"                   , version: "23.2.202" },
        { name: "@infragistics/igniteui-angular-excel"                    , version: "23.2.202" },
        { name: "@infragistics/igniteui-angular-gauges"                   , version: "23.2.202" },
        { name: "@infragistics/igniteui-angular-inputs"                   , version: "23.2.202" },
        { name: "@infragistics/igniteui-angular-layouts"                  , version: "23.2.202" },
        { name: "@infragistics/igniteui-angular-maps"                     , version: "23.2.202" },
        { name: "@infragistics/igniteui-angular-spreadsheet-chart-adapter", version: "23.2.202" },
        { name: "@infragistics/igniteui-angular-spreadsheet"              , version: "23.2.202" },
        { name: "@infragistics/igniteui-angular-datasources"              , version: "23.2.202" },
        // these IG packages are sometimes updated:
        { name: "igniteui-webcomponents",            version: "4.9.0" },
        { name: "igniteui-theming",                  version: "6.2.0 " },
        { name: "igniteui-angular",                  version: "17.2.2" },
