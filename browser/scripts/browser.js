...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "22.0.0-alpha.0", name: "igniteui-angular-core" },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-charts" },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-excel" },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-gauges" },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-data-grids" },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-inputs" },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-layouts" },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-maps" },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-spreadsheet-chart-adapter"  },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-spreadsheet" },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-datasources" },
        { version: "22.0.0-alpha.0", name: "igniteui-angular-dashboards" },
        // these IG packages are sometimes updated:
        { version: "7.2.2" , name: "igniteui-webcomponents" },
        { version: "22.0.0-beta.2", name: "igniteui-angular" },
